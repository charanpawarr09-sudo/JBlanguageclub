                ...
                >
                    ...
                    {isConfirmed ? (
                        ...
                        <>
                            ...
                            <p className="text-white/50 mb-4">Your details are saved. Please open the form to complete the payment/confirmation.</p>
                            <Link
                                to={ROUTES.REGISTER}
                            ...
                            >
                                Open Form Link <ExternalLink className="w-4 h-4" />
                            </Link>
                        </>
                    ) : (
                        <>
