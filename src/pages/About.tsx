                                            ...
                                            >
                                                ...
                                                <div className="relative z-10 text-center max-w-2xl mx-auto">
                                                    ...
                                                    >
                                                        ...
                                                        <div className="relative rounded-full p-[3px] overflow-hidden" style={{ background: 'conic-gradient(from 0deg, #14b8a6, #f59e0b, #8b5cf6, #ec4899, #14b8a6)' }}>
                                                            <div className="rounded-full overflow-hidden">
                                                                {member.photo_url ? (
                                                                    ...
                                                                    <div className="w-40 h-40 sm:w-48 sm:h-48 bg-gradient-to-br from-teal-600 via-teal-700 to-emerald-800 flex items-center justify-center text-white text-5xl sm:text-6xl font-bold">
